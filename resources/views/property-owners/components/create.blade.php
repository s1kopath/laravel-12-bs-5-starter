<div class="modal-header">
    <h5 class="modal-title text-brand">Add Property Owner</h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
<form method="POST" action="{{ route('property-owners.store') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary">Create Property Owner</button>
    </div>
</form>
